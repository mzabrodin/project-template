...
def main():
    ...
    pandas_file_text = input_from_file_using_pandas("pandas_input.txt")

    output_to_console(console_text)
    output_to_console(file_text)
    output_to_console(pandas_file_text.to_string())

    output_to_file("output.txt", file_text)
    output_to_file_using_pandas("pandas_output.txt", pandas_file_text)
